...
import com.vvxc.autocontrol.service.FileService;
...
//        String fileName = new Date().getTime()+".jpg";
    ...
    public ResponseEntity<byte[]> download(HttpServletRequest request,int id) throws IOException {
        com.vvxc.autocontrol.model.File mfile=service.findFileById(id);
    ...
    public @ResponseBody List<com.vvxc.autocontrol.model.File> listAll(){
